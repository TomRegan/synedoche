...
#cone.SetHeight(3.0) # TR 2011-07-29
cone.SetRadius(1.0)
#cone.SetResolution(10)
cone.SetThetaResolution(100) # TR 2011-07-29
...
popup = vtk.vtkBalloonWidget()
#popup.SetInteractor(iren)
popup.SetRepresentation(balloon)
popup.AddBalloon(coneActor, "Sphere")
