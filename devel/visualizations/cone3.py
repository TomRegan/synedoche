...
ren1.SetBackground(1.0, 1.0, 1.0) # TR 2011-07-29
ren1.SetViewport(0.0, 0.0, 0.5, 1.0)

ren2 = vtk.vtkRenderer()
ren2.AddActor(coneActor)
ren2.SetBackground(1.0, 1.0, 1.0) # TR 2011-07-29
...
#renWin.BordersOff() # TR 2011-07-29
...
ren1.GetActiveCamera().Roll(5) # TR 2011-07-29
